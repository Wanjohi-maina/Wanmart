    ...
    switch (row.kind) {
        case 'electronics':
            return {
                ...
                storageOptions: attributes.storageOptions as { label: string; priceModifier: number }[],
                colorImages: attributes.colorImages as Record<string, string>,
                galleryByColor: attributes.galleryByColor as Record<string, string[]> | undefined,
            }
