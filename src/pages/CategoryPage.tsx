...
export default function CategoryPage() {
  ...
  const results = useMemo(() => {
    // Use useMemo to memoize the sorted products based on the matched products and the selected sort option, so that the sorting logic is only re-executed when these dependencies change
    if (sort === "price-asc")
      return [...matched].sort((a, b) => a.price - b.price); // Sort the matched products in ascending order of price
    if (sort === "price-desc")
