                        ...
                        return (
                            <li key={parent.id}>
                                <div className='flex w-full items-center justify-between'>
                                    ...
                                    >
                                        {openCategory === parent.id ? '-' : '+'} {/* Display a '-' sign if the current parent category is expanded (openCategory matches the parent ID), otherwise display a '+' sign to indicate that it can be expanded. */}
                                    </button>
                                </div>
